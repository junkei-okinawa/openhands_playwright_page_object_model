...
- `pages/`: ページオブジェクトクラスが含まれています。
     8    - `base_page.py`: 共通のページ操作を定義するBasePageクラスが含まれています。
     9    - `docs_page.py`: `Docs` ページのページオブジェクトクラスが含まれています。
    10    - `enterprise_page.py`: `Enterprise` ページのページオブジェクトクラスが含まれています。
    11    - `locators.py`: ページ要素のロケータを定義するクラスが含まれています。
